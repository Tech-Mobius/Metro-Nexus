  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-[2] flex h-full flex-col items-center justify-center px-6 text-center">
        ...
        >
          <HyperText duration={1000} className="text-4xl sm:text-5xl md:text-7xl lg:text-[5.5rem] inline-block" as="span">The City Is Your</HyperText>
          <br />
          <HyperText duration={1000} delay={400} className="text-4xl sm:text-5xl md:text-7xl lg:text-[5.5rem] inline-block text-white" as="span">Living Canvas</HyperText>
        </h1>
        ...
        <div className="liquid-glass mt-8 flex w-full max-w-[320px] items-center rounded-full p-1.5 sm:max-w-sm">
          <input
            type="email"
